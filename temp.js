...
destinationSquare = destination.target;
    ...
    function removePiece(destination) {
        colour = valueInSquare
                    if(stateGrid[destination.target]){
                        if(n){
                        let index = stateGrid[i];
                        let enemyPieceType = mapPieces[index];
                        console.log(index + "!!");
                        console.log(enemyPieceType + "!!")
                        return enemyPieceType;
                        }

                    }
                    let result = removePiece(i); 
                    console.log(result + "!!");

                    let pieceIndexToRemove = Number(
                    pieceSquarePositionArray.white[result].indexOf(i)
                    );
                    
                    console.log(pieceSquarePositionArray.white[result])
                        
                    if(stateGrid[destination]){
                     pieceElementsObject.white[result][pieceIndexToRemove].remove();
                    }
                }
